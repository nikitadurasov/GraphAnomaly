...
class AWE(object):
    ...
    def __init__(self,
        ...
        #self.sorted_graphs = random.sample(self.sorted_graphs[:10], 10) + self.sorted_graphs[10:]
        #print("RANDOM SHUFFLE", self.sorted_graphs[:10])
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default(), tf.device('/cpu:0'):
            ...
            self.normalized_word_embeddings = self.word_embeddings
            ...
            self.normalized_doc_embeddings = self.doc_embeddings
